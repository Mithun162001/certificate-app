...
if 'Coursera' in selected:
    ...
    if 'Google Crash Course on Python' in new_select:
        ...
        google = Image.open("google-image.png")
    ...
    if 'Google Data Analytics' in new_select:
        ...
        google_1 = Image.open("0001.jpg")
        google_2 = Image.open("0002.jpg")
...
if 'LinkedIn Learning' in selected:
    ...
    if 'Data Science Essentials - Part 1' in new_select_2:
        ...
        ll1 = Image.open("essential-image.png")
    ...
    if 'Statistics Foundations' in new_select_2:
        ...
        ll2 = Image.open("1.jpg")
        ll3 = Image.open("2.jpg")
        ll4 = Image.open("3.jpg")
...
if 'Kaggle' in selected:
    ...
    kaggle_1 = Image.open("Kaggle Python Certficate.png")
    kaggle_2 = Image.open("Kaggle Pandas Certficate.png")
    kaggle_3 = Image.open("Mithun G - Data Visualization.png")
    kaggle_4 = Image.open("Kaggle - Intro to Machine Learning.png")
